...
export const courses = [ 
    {
        ...
        paragraph2 :"Learn and explore the technologies behind modern-day breakthroughs in the fields of computer vision, natural language processing, recommender systems, autofocus driving and more. ",
    ...
    },
    {
          ...
          paragraph2 :"Learn C# and develop interactive mixed-reality projectsin Unity3D, the world’s leading real-time game engine.",
    ...
    },
    {
        ...
        paragraph2 :"Advance your skills in front-end, back-end and React development to create, maintain,and improve web applications and APIs.",
  ...
  },
  {
        id:"4",
         ...
         paragraph2 :"Dive into the C programming language, the Linux operating system, and uncover the mechanisms behind Blockchain technology by building your own cryptocurrency from scratch. ",
  ...
  },
  {
    ...
    paragraph2 :"The work of front-end developers is what helps technology be usable to the average person, and companies with the best, most stable, and most usable sites are the most popular on the web. ",
  ...
  },
{
    ...
    paragraph2 :"Finding the perfect rental, sharing a photo from the cloud, and keeping data secure while using the web are all driven by back-end web developers.",
